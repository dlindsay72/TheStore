        ...
        if let url = url {
            ...
            do {
                ...
                for json in jsonArray {
                    ...
                    guard let productId = productData["id"], let name = productData["name"], let type = productData["type"] else { return } // he has this on three different lines
                    ...
                    if let regularPrice = productData["regularPrice"], let salePrice = productData["salePrice"], let quantity = productData["quantity"], let rating = productData["rating"] {
